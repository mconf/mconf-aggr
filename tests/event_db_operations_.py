...
from mconf_aggr.webhook.db_operations import DataProcessor, Meetings, UsersEvents
...
class TestOperationsMeetings(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        session_mock.query().get.return_value = Meetings(
            running=False,
        ...
        data = ["mock1", "mock2"]
        cls.data_processor = DataProcessor(session_mock, data)
    ...
    def test_create_event(self):
        data = [
            ...
            },
            {
                ...
                "max_users": 12,
                "is_breakout": False,
                "meta_data": {"anything_set_here": "any-other", "anotherMeta": "123"},
            },
        ]
...
class TestOperationsUsers(unittest.TestCase):
    ...
    def test_left_event(self):
        data = [
            ...
            {"internal_user_id": "mock", "external_user_id": "mock", "leave_time": 999},
        ]
        self.data_processor.webhook_msg = data[0]
        self.data_processor.mapped_msg = data[1]
                ...
                "data": {
                    ...
                    "attributes": {
                        ...
                        "recording": {
                            ...
                            "size": 45,
                            "raw-size": 443,
                            "metadata": {"something": "set"},
                            "playback": {"something": "set"},
                            "download": {"something": "set"},
                        },
                        "event": {"ts": 1502810164922},
                    },
                }
