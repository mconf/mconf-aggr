...
class Config:
    ...
    def randomize_configuration(self):
        ...
        self.institution = Institution(self.institutions[index]["name"], self.institutions[index]["guid"])
        self.shared_secret = SharedSecret(self.shared_secrets[index]["name"], self.shared_secrets[index]["guid"])
