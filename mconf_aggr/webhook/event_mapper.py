...
def map_webhook_event(event):
    ...
    if event_type == "meeting-created":
        ...
        mapped_event = _map_rap_publish_event(event, event_type)
        ...
        mapped_event = _map_rap_process_event(event, event_type)
...
def _map_rap_process_event(event, event_type):
...
def _map_rap_publish_event(event, event_type):
